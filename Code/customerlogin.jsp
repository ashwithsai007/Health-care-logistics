...
<nav>
    <ul>
        ...
        <li>
            <a href="technicianlogin.html">Technician</a>
        </li>
        <li>
            <a href="customerlogin.html" class="active">Customer</a>
        </li>
    </ul>
</nav>
<!-- Login Form -->
<div class="form-div animated fadeInUpBig">
    ...
    <form action="customeract.html" method="post">
        ...
        <p><a href="customerreg.html" class="reg">New User Register Here...</a></p>
        <br>
    </form>
</div>
<br><br><br>
